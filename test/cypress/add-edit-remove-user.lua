...
function g.test_cypress_run()
    local code = os.execute("cd webui && npx cypress run --spec cypress/integration/add-user.spec.js, cypress/integration/edit-user.spec.js, cypress/integration/remove-user.spec.js")
