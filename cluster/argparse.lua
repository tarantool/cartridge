...
local vars = require('cluster.vars').new('cluster.argparse')
...
--    get_opts(cluster_opts) -> {alias = "router"} -- a string
--    get_opts(box_opts) -> {memtx_memory = 100} -- a number
--
-- @function get_opts
