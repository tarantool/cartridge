...
- Update ``membership`` dependency to `2.5.4 <https://github.com/tarantool/membership/releases/tag/2.5.4>`_.
...
- Update ``vshard`` dependency to `0.1.41 <https://github.com/tarantool/vshard/releases/tag/0.1.41>`_.
...
- Update ``vshard`` dependency to `0.1.40 <https://github.com/tarantool/vshard/releases/tag/0.1.40>`_.
...
- Update ``vshard`` dependency to `0.1.39 <https://github.com/tarantool/vshard/releases/tag/0.1.39>`_.
...
- Update ``checks`` dependency to `3.4.0 <https://github.com/tarantool/checks/releases/tag/3.4.0>`_.
...
- ``config_applied`` variable from ``cartridge.twophase`` module, as it only
  reflected local configuration state.
...
- Update ``http`` dependency to `1.8.0 <https://github.com/tarantool/http/releases/tag/1.8.0>`_.
