...
import { getFilesQuery, setFilesMutation, validateFilesQuery } from './queries.graphql';
...
export const validateFiles = (sections: ConfigSectionInput[]) =>
  graphql.fetch(validateFilesQuery, { sections }).then(({ cluster: { validate_config } }) => validate_config);
