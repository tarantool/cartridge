...
const cmpByFileName = (a, b) => (a.fileName < b.fileName && -1) || (a.fileName > b.fileName && 1) || 0;
...
export const selectFileTree = createSelector(
  ...
  (files: Array<FileItem>): Array<TreeFileItem> => {
    const fileMap: { [string]: TreeFileItem } = files.reduce((tree, file) => {
...
export const selectFilePaths = createSelector(
  [(files: Array<FileItem>) => files],
  (files: Array<FileItem>): Array<string> =>
