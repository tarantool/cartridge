...
import { probeServer, setProbeServerModalVisible } from 'src/store/actions/clusterPage.actions';
...
class ProbeServerModal extends React.PureComponent<ProbeServerModalProps> {
  render() {
    const { error, probeServerModalVisible, setProbeServerModalVisible } = this.props;
