describe('Web UI features testing', () => {
  ...
  describe('Test LeftMenu stage', () => {
    ...
    it.skip('Test: left menu state is saving when page is reloaded', () => {
      ////////////////////////////////////////////////////////////////
      cy.setLocalStorage('tt.menu_collapsed', '0');
    ...
    it.skip('Test: left menu state is saving when page is reopened with collapsed menu', () => {
      ////////////////////////////////////////////////////////////////
    ...
    it.skip('Test: left menu state is saving when page is reopened with not collapsed menu', () => {
      ////////////////////////////////////////////////////////////////
      cy.log('check left menu is not collappsed');
      ////////////////////////////////////////////////////////////////
      cy.getLocalStorage('tt.menu_collapsed').then(($isSideMenuClosed) => {
